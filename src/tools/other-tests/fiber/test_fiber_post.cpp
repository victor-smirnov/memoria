...
void fn5() {
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, fn4);
...
void test_join_fn() {
    {
        value1 = 0;
        memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, fn1);
        f.join();
    ...
    }
    {
        value1 = 0;
        value2 = "";
        memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, fn2, 3, "abc");
        f.join();
...
void test_join_memfn() {
    ...
    memoria::v1::fibers::fiber( memoria::v1::fibers::launch::post, & X::foo, std::ref( x), 3).join();
...
void test_join_copyable() {
    ...
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, cp);
    f.join();
    BOOST_CHECK( cp.state);
    BOOST_CHECK_EQUAL( value1, 3);
}
...
void test_join_moveable() {
    ...
    BOOST_CHECK_EQUAL( value1, 0);
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, std::move( mv) );
    f.join();
    BOOST_CHECK( ! mv.state);
...
void test_join_lambda() {
    {
        ...
        memoria::v1::fibers::fiber f(
                memoria::v1::fibers::launch::post, [i,abc]() {
                    value1 = i;
                    value2 = abc;
                });
        f.join();
    ...
    }
    {
        ...
        std::string abc("abc");
        memoria::v1::fibers::fiber f(
                memoria::v1::fibers::launch::post, [](int i, std::string const& abc) {
                    value1 = i;
                    value2 = abc;
                },
                i, abc);
...
void test_join_bind() {
    {
        ...
        std::string abc("abc");
        memoria::v1::fibers::fiber f(
            memoria::v1::fibers::launch::post, std::bind(
                [i,abc]() {
                    value1 = i;
                    value2 = abc;
                }
...
void test_join_in_fiber() {
    ...
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, fn5);
    BOOST_CHECK( f.joinable() );
...
void test_move_fiber() {
    ...
    memoria::v1::fibers::fiber f2( memoria::v1::fibers::launch::post, fn1);
...
void test_id() {
    ...
    memoria::v1::fibers::fiber f3( memoria::v1::fibers::launch::post, fn1);
...
void test_yield() {
    ...
    memoria::v1::fibers::fiber f1( memoria::v1::fibers::launch::post, fn3, std::ref( v1) );
    memoria::v1::fibers::fiber f2( memoria::v1::fibers::launch::post, fn3, std::ref( v2) );
    f1.join();
    f2.join();
    BOOST_CHECK( ! f1.joinable() );
    BOOST_CHECK( ! f2.joinable() );
...
void test_detach() {
    {
        memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, (detachable()) );
        BOOST_CHECK( f.joinable() );
        f.detach();
        BOOST_CHECK( ! f.joinable() );
