...
void test_push() {
    ...
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, [&c](){
...
void test_pop() {
    memoria::v1::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, [&v1,&c](){
...
void test_pop_success() {
    memoria::v1::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, [&c,&v2](){
        BOOST_CHECK( memoria::v1::fibers::channel_op_status::success == c.pop( v2) );
    });
    BOOST_CHECK( memoria::v1::fibers::channel_op_status::success == c.push( v1) );
    f.join();
...
void test_value_pop() {
    memoria::v1::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    memoria::v1::fibers::fiber f( memoria::v1::fibers::launch::post, [&c,&v1](){
        BOOST_CHECK( memoria::v1::fibers::channel_op_status::success == c.push( v1) );
    });
    v2 = c.value_pop();
    f.join();
...
void test_rangefor() {
    ...
    std::vector< int > vec;
    memoria::v1::fibers::fiber f1( memoria::v1::fibers::launch::post, [&chan]{
        chan.push( 1);
        chan.push( 1);
        chan.push( 2);
        chan.push( 3);
    ...
    memoria::v1::fibers::fiber f2( memoria::v1::fibers::launch::post, [&vec,&chan]{
        for ( int value : chan) {
            vec.push_back( value);
        }
    });
