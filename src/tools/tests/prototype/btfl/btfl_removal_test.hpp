...
template <
    ...
    typename ProfileT
>
class BTFLRemovalTest<BTFLTestCtr<Levels, SizeType>, AllocatorT, ProfileT>: public BTFLTestBase<BTFLTestCtr<Levels, SizeType>, AllocatorT, ProfileT> {

    using CtrName = BTFLTestCtr<Levels, SizeType>;

    using Base   = BTFLTestBase<CtrName, AllocatorT, ProfileT>;
    using MyType = BTFLRemovalTest<CtrName, AllocatorT, ProfileT>;
