...
template <
    ...
    typename ProfileT
>
class BTFLInsertionTest<BTFLTestCtr<Levels, SizeType>, AllocatorT, ProfileT>: public BTTLTestBase<BTTLTestCtr<Levels, SizeType>, AllocatorT, ProfileT> {

    using CtrName = BTFLTestCtr<Levels, SizeType>;

    using Base   = BTFLTestBase<CtrName, AllocatorT, ProfileT>;
    using MyType = BTFLInsertionTest<CtrName, AllocatorT, ProfileT>;
...
public:
    ...
    virtual ~BTFLInsertionTest() throw () {}
