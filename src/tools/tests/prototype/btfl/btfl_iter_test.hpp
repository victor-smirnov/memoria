...
>
class BTFLIterTest: public BTFLTestBase<CtrName, AllocatorT, ProfileT> {

    using Base   = BTFLTestBase<CtrName, AllocatorT, ProfileT>;
    using MyType = BTFLIterTest<CtrName, AllocatorT, ProfileT>;
