...
#ifndef MEMORIA_TESTS_FILEALLOC_VECTOR_TEST_HPP_
#define MEMORIA_TESTS_FILEALLOC_VECTOR_TEST_HPP_
...
template <typename T>
class FileAllocatorVectorTest: public FASequenceCreateTestBase<
    Vector<T>,
    vector<T>
>
{
    typedef FileAllocatorVectorTest<T>                                          MyType;
    typedef MyType                                                              ParamType;

    typedef FASequenceCreateTestBase<
                Vector<T>,
                vector<T>
    >                                                                           Base;
...
public:
    FileAllocatorVectorTest(StringRef name):
        Base(name)
    {
