...
#ifndef MEMORIA_TESTS_PACKEDLOUDS_SUBTREE_HPP_
#define MEMORIA_TESTS_PACKEDLOUDS_SUBTREE_HPP_
...
class PackedLoudsSubtreeTest: public PackedLoudsTestBase {

	typedef PackedLoudsTestBase													Base;
    typedef PackedLoudsSubtreeTest 												MyType;

public:

    PackedLoudsSubtreeTest(): PackedLoudsTestBase("Subtree")
    {
    ...
    virtual ~PackedLoudsSubtreeTest() throw() {}
