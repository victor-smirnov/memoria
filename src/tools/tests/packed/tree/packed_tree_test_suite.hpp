...
public:
    ...
    PackedTreeTestSuite(): TestSuite("Packed.TreeSuite")
    {
    	...
    	registerTask(new PackedTreeMiscTest<PackedVLETree, UByteExintCodec, 4>("Misc.4.VLE.Exint"));
        registerTask(new PackedTreeMiscTest<PackedVLETree, UBigIntEliasCodec, 4>("Misc.4.VLE.Elias"));
        ...
        registerTask(new PackedTreeSumTest<PackedVLETree,  UBigIntEliasCodec, 4>("Sum.4.VLE.Elias"));

    	registerTask(new PackedTreeFindTest<PackedVLETree,  UBigIntEliasCodec, 4>("Find.4.VLE.Elias"));
    	registerTask(new PackedTreeFindTest<PackedVLETree,  UByteExintCodec, 4>("Find.4.VLE.Exint"));
