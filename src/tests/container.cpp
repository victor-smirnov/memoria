...
class CtrHelper: public CtrPart<typename SelectByIndexTool<Idx, typename Types::List>::Result, CtrHelper<Idx - 1, Types, Type>, Types, Type> {
	typedef Type<Types> MyType;
	typedef CtrHelper<Idx, Types, Type> ThisType;
	typedef CtrPart<typename SelectByIndexTool<Idx, typename Types::List>::Result, CtrHelper<Idx - 1, Types, Type>, Types, Type> BaseType;
