...
.text
.p2align 4,,15
.globl	_memoria_make_fcontext
.def	_memoria_make_fcontext;	.scl	2;	.type	32;	.endef
_memoria_make_fcontext:
    /* first arg of memoria_make_fcontext() == top of context-stack */
    movl  0x04(%esp), %eax
    ...
    movl  %ecx, 0x14(%eax)
    /* second arg of memoria_make_fcontext() == size of context-stack */
    movl  0x8(%esp), %edx
    ...
    /* third arg of memoria_make_fcontext() == address of context-function */
    /* stored in EBX */
    movl  0xc(%esp), %ecx
    movl  %ecx, 0x24(%eax)
    ...
    /* will be entered after calling memoria_jump_fcontext() first time */
    movl  %ecx, 0x2c(%eax)
...
.section .drectve
.ascii " -export:\"memoria_make_fcontext\""
