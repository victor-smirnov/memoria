...
Result<SharedPtr<IMemoryStore<ApiProfileT>>> create_memory_store_cowlite() noexcept
{
...
Result<SharedPtr<IMemoryStore<ApiProfileT>>> load_memory_store_cowlite(U8String path) noexcept {
...
Result<AllocSharedPtr<IMemoryStore<ApiProfileT>>> load_memory_store_cowlite(InputStreamHandler* input_stream) noexcept
{
