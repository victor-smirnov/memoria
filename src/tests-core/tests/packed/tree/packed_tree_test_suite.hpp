...
public:
    ...
    PackedTreeTestSuite(): TestSuite("Packed.Tree")
    {
        ...
        registerTask(new PackedTreeMiscTest<PkdVQTreeT<int64_t, 4, UInt64EliasCodec>>("Misc.4.VLQ.Elias"));
        registerTask(new PackedTreeMiscTest<PkdVDTreeT<int64_t, 4, UInt64EliasCodec>>("Misc.4.VLD.Elias"));

        registerTask(new PackedTreeSumTest<PkdVQTreeT<int64_t, 4,  UByteI7Codec>>("Sum.4.VLQ.I7"));
        registerTask(new PackedTreeSumTest<PkdVQTreeT<int64_t, 4,  UInt64EliasCodec>>("Sum.4.VLQ.Elias"));
        registerTask(new PackedTreeSumTest<PkdVDTreeT<int64_t, 4,  UInt64EliasCodec>>("Sum.4.VLD.Elias"));

        registerTask(new PackedTreeFindTest<PkdVQTreeT<int64_t, 4, UInt64EliasCodec>>("Find.4.VLQ.Elias"));
        ...
        registerTask(new PackedTreeInputBufferTest<PkdVQTreeT<int64_t, 4, UInt64EliasCodec>>("Buffer.4.VLQ.Elias"));

        registerTask(new PackedTreeInputBufferTest<PkdVDTreeT<int64_t, 4, UByteI7Codec>>("Buffer.4.VLD.I7"));
        registerTask(new PackedTreeInputBufferTest<PkdVDTreeT<int64_t, 4, UInt64EliasCodec>>("Buffer.4.VLD.Elias"));
