...
void fn2() {
    ...
    memoria::v1::fibers::shared_future< int > f( p.get_future().share() );
    memoria::v1::this_fiber::yield();
...
void test_shared_future_create() {
    {
        ...
        memoria::v1::fibers::shared_future< int > f1;
        memoria::v1::fibers::shared_future< int > f2 = f1;
...

    {
        ...
        memoria::v1::fibers::promise< int > p;
        memoria::v1::fibers::shared_future< int > f1 = p.get_future();
        memoria::v1::fibers::shared_future< int > f2 = f1;
        BOOST_CHECK( f1.valid() );
        BOOST_CHECK( f2.valid() );
    }
...
void test_shared_future_create_void() {
    {
        // default constructed and assigned shared_future is not valid
        memoria::v1::fibers::shared_future< void > f1;
        memoria::v1::fibers::shared_future< void > f2 = f1;
        BOOST_CHECK( ! f1.valid() );
        BOOST_CHECK( ! f2.valid() );
    }
    ...
    {
        // shared_future retrieved from promise is valid
        memoria::v1::fibers::promise< void > p;
        memoria::v1::fibers::shared_future< void > f1 = p.get_future();
        memoria::v1::fibers::shared_future< void > f2 = f1;
        BOOST_CHECK( f1.valid() );
        BOOST_CHECK( f2.valid() );
    }
...
void test_shared_future_get() {
    ...
    memoria::v1::fibers::shared_future< int > f1 = p1.get_future().share();
    BOOST_CHECK( f1.valid() );
...
void test_shared_future_get_move() {
    ...
    memoria::v1::fibers::shared_future< A > f1 = p1.get_future().share();
    BOOST_CHECK( f1.valid() );
...
void test_shared_future_get_void() {
    ...
    memoria::v1::fibers::shared_future< void > f1 = p1.get_future().share();
    BOOST_CHECK( f1.valid() );
...
void test_shared_future_wait_for() {
    ...
    memoria::v1::fibers::fiber( memoria::v1::fibers::launch::dispatch, fn11, std::move( p1) ).detach();
...
void test_shared_future_wait_for_ref() {
    ...
    memoria::v1::fibers::fiber( memoria::v1::fibers::launch::dispatch, fn12, std::move( p1) ).detach();
...
void test_shared_future_wait_for_void() {
    ...
    memoria::v1::fibers::fiber( memoria::v1::fibers::launch::dispatch, fn13, std::move( p1) ).detach();
...
void test_shared_future_wait_with_fiber_1() {
    memoria::v1::fibers::promise< int > p1;
    memoria::v1::fibers::fiber( memoria::v1::fibers::launch::dispatch, fn1, & p1, 7).detach();
...
void test_shared_future_wait_with_fiber_2() {
    memoria::v1::fibers::fiber( memoria::v1::fibers::launch::dispatch, fn2).join();
}
...
void test_shared_future_move() {
    ...
    // move construction
    memoria::v1::fibers::shared_future< int > f2( std::move( f1) );
    BOOST_CHECK( ! f1.valid() );
    BOOST_CHECK( f2.valid() );
...
void test_shared_future_move_move() {
    ...
    // move construction
    memoria::v1::fibers::shared_future< A > f2( std::move( f1) );
    BOOST_CHECK( ! f1.valid() );
    BOOST_CHECK( f2.valid() );
...
void test_shared_future_move_void() {
    ...
    // move construction
    memoria::v1::fibers::shared_future< void > f2( std::move( f1) );
    BOOST_CHECK( ! f1.valid() );
    BOOST_CHECK( f2.valid() );
