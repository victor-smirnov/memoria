...
void test_push() {
    memoria::fibers::unbuffered_channel< int > c;
    memoria::fibers::fiber f( memoria::fibers::launch::post, [&c](){
        BOOST_CHECK( memoria::fibers::channel_op_status::success == c.push( 1) );
    });
    int value = 0;
    BOOST_CHECK( memoria::fibers::channel_op_status::success == c.pop( value) );
...
void test_pop() {
    memoria::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    memoria::fibers::fiber f( memoria::fibers::launch::post, [&v1,&c](){
...
void test_pop_success() {
    memoria::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    memoria::fibers::fiber f( memoria::fibers::launch::post, [&c,&v2](){
        BOOST_CHECK( memoria::fibers::channel_op_status::success == c.pop( v2) );
    });
    BOOST_CHECK( memoria::fibers::channel_op_status::success == c.push( v1) );
    f.join();
...
void test_value_pop() {
    memoria::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    memoria::fibers::fiber f( memoria::fibers::launch::post, [&c,&v1](){
        BOOST_CHECK( memoria::fibers::channel_op_status::success == c.push( v1) );
    });
    v2 = c.value_pop();
    f.join();
...
void test_pop_wait_until_timeout() {
    ...
    int v = 0;
    BOOST_CHECK(
            memoria::fibers::channel_op_status::timeout == c.pop_wait_until( v,
                std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_moveable() {
    memoria::fibers::unbuffered_channel< moveable > c;
    memoria::fibers::fiber f( memoria::fibers::launch::post, [&c]{
        moveable m1( 3);
...
void test_rangefor() {
    memoria::fibers::unbuffered_channel< int > chan;
    std::vector< int > vec;
    memoria::fibers::fiber f1( memoria::fibers::launch::post, [&chan]{
        chan.push( 1);
        chan.push( 1);
        chan.push( 2);
        chan.push( 3);
    ...
    memoria::fibers::fiber f2( memoria::fibers::launch::post, [&vec,&chan]{
        for ( int value : chan) {
            vec.push_back( value);
        }
    });
