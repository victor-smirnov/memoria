...
void f1( ctx::transfer_t t) {
    ++value1;
    ctx::memoria_jump_fcontext( t.fctx, t.data);
}

void f3( ctx::transfer_t t_) {
    ++value1;
    ctx::transfer_t t = ctx::memoria_jump_fcontext( t_.fctx, 0);
    ++value1;
    ctx::memoria_jump_fcontext( t.fctx, t.data);
}
...
void f4( ctx::transfer_t t) {
    int i = 7;
    ctx::memoria_jump_fcontext( t.fctx, & i);
}
...
void f6( ctx::transfer_t t_) {
    ...
    ctx::transfer_t t = ctx::memoria_jump_fcontext( t_.fctx, & res);
    data = * ( std::pair< int, int > *) t.data;
    res = data.first + data.second;
    ctx::memoria_jump_fcontext( t.fctx, & res);
}
...
void f8( ctx::transfer_t t) {
    ...
    d += 3.45;
    value3 = d;
    ctx::memoria_jump_fcontext( t.fctx, 0);
}
...
void f9( ctx::transfer_t t) {
    ...
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f10);
    ctx::memoria_jump_fcontext( ctx, 0);
    ctx::memoria_jump_fcontext( t.fctx, 0);
}
...
void f12( ctx::transfer_t t_) {
    ctx::transfer_t t = ctx::memoria_jump_fcontext( t_.fctx, t_.data);
    value1 = * ( int *) t.data;
    ctx::memoria_jump_fcontext( t.fctx, t.data);
}
...
void test_setup() {
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f1);
    BOOST_CHECK( ctx);
...
void test_jump() {
    ...
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f3);
    BOOST_CHECK( ctx);
    BOOST_CHECK_EQUAL( 0, value1);
    ctx::transfer_t t = ctx::memoria_jump_fcontext( ctx, 0);
    BOOST_CHECK_EQUAL( 1, value1);
    ctx::memoria_jump_fcontext( t.fctx, 0);
...
void test_result() {
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f4);
    BOOST_CHECK( ctx);
    ctx::transfer_t t = ctx::memoria_jump_fcontext( ctx, 0);
...
void test_arg() {
    ...
    int i = 7;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f5);
    BOOST_CHECK( ctx);
    ctx::transfer_t t = ctx::memoria_jump_fcontext( ctx, & i);
    int result = * ( int *) t.data;
...
void test_transfer() {
    ...
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f6);
    BOOST_CHECK( ctx);
    ctx::transfer_t t = ctx::memoria_jump_fcontext( ctx, & data);
    int result = * ( int *) t.data;
    BOOST_CHECK_EQUAL( 10, result);
    data = std::make_pair( 7, 7);
    t = ctx::memoria_jump_fcontext( t.fctx, & data);
    result = * ( int *) t.data;
...
void test_exception() {
    ...
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f7);
    BOOST_CHECK( ctx);
    ctx::memoria_jump_fcontext( ctx, & what);
...
void test_fp() {
    ...
    double d = 7.13;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f8);
    BOOST_CHECK( ctx);
    ctx::memoria_jump_fcontext( ctx, & d);
...
void test_stacked() {
    ...
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize());
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f9);
    ctx::memoria_jump_fcontext( ctx, 0);
...
void test_ontop() {
    ...
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f12);
    BOOST_CHECK( ctx);
    ctx::transfer_t t = ctx::memoria_jump_fcontext( ctx, 0);
    BOOST_CHECK_EQUAL( 0, value1);
    BOOST_CHECK( 0 == value4);
    int i = -3;
    t = ctx::memoria_ontop_fcontext( t.fctx, & i, f11);
    BOOST_CHECK_EQUAL( -3, value1);
...
void test_sscanf() {
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f13);
    BOOST_CHECK( ctx);
    ctx::memoria_jump_fcontext( ctx, 0);
	alloc.deallocate( sp, stack_allocator::default_stacksize() );
}
...
void test_snprintf() {
    stack_allocator alloc;
    void * sp = alloc.allocate( stack_allocator::default_stacksize() );
    ctx::fcontext_t ctx = ctx::memoria_make_fcontext( sp, stack_allocator::default_stacksize(), f14);
    ctx::memoria_jump_fcontext( ctx, 0);
	alloc.deallocate( sp, stack_allocator::default_stacksize() );
}
