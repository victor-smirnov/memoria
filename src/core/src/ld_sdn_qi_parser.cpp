...
using MapEntryTuple = bf::vector<LDString, LDDValue>;
...
using TypeDeclOrReference = boost::variant<LDIdentifier, LDTypeDeclarationValue>;
...
using LDDTypedValueValueBase = bf::vector<TypeDeclOrReference, LDDValue>;
...
struct LDDTypedValueValue: LDDTypedValueValueBase {
    ...
    struct Visitor: public boost::static_visitor<> {
        ...
        void operator()(LDIdentifier ref){
...
struct SDNParser : qi::grammar<Iterator, LDDocument(), qi::space_type>
{
    ...
    qi::rule<Iterator, LDDValue(), qi::space_type> sdn_value;
    qi::rule<Iterator, LDDValue(), qi::space_type> standalone_sdn_value;
    ...
    qi::rule<Iterator, LDString(), qi::space_type> sdn_string;
    ...
    qi::rule<Iterator, LDIdentifier(), qi::space_type> sdn_identifier;

    qi::rule<Iterator, LDTypeDeclarationValue(), qi::space_type> type_declaration;
    qi::rule<Iterator, LDTypeDeclaration(), qi::space_type> standalone_type_decl;
    ...
    qi::rule<Iterator, LDIdentifier(), qi::space_type> type_reference;
...
template <typename Iterator>
struct TypeDeclarationParser : qi::grammar<Iterator, LDTypeDeclaration(), qi::space_type>
{
...
template <typename Iterator>
struct RawSDNValueParser : qi::grammar<Iterator, LDDValue(), qi::space_type>
{
    SDNParser<Iterator> sdn_parser;
