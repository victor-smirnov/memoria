...
st::InputChannelImplPtr SeastarHRPCCall::make_input_channel(ChannelCode code)
{
...
st::OutputChannelImplPtr SeastarHRPCCall::make_output_channel(ChannelCode code)
{
    static thread_local auto pool =
