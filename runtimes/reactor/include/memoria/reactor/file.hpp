...
File open_buffered_file(boost::filesystem::path file_path, FileFlags flags, FileMode mode = FileMode::IDEFLT);
...
DMAFile open_dma_file(boost::filesystem::path file_path, FileFlags flags, FileMode mode = FileMode::IDEFLT);
