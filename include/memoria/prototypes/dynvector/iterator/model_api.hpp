...
#ifndef MEMORIA_PROTOTYPES_DYNVECTOR_ITERATOR_MODEL_API_H
#define MEMORIA_PROTOTYPES_DYNVECTOR_ITERATOR_MODEL_API_H
...
MEMORIA_ITERATOR_PART_BEGIN(memoria::dynvector::IteratorContainerAPIName)
