...
#ifndef _MEMORIA_PROTOTYPES_BTTL_CTR_BRANCH_COMMON_HPP
#define _MEMORIA_PROTOTYPES_BTTL_CTR_BRANCH_COMMON_HPP
...
#define M_TYPE      MEMORIA_CONTAINER_TYPE(memoria::bttl::BranchCommonName)
