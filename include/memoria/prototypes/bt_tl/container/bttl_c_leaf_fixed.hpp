...
#ifndef _MEMORIA_PROTOTYPES_BTTL_CTR_INSERT_BATCH_FIXED_HPP
#define _MEMORIA_PROTOTYPES_BTTL_CTR_INSERT_BATCH_FIXED_HPP
...
#define M_TYPE      MEMORIA_CONTAINER_TYPE(memoria::bttl::InsertBatchFixedName)
