...
#ifndef _MEMORIA_PROTOTYPES_BTTL_ITER_UPDATE_HPP
#define _MEMORIA_PROTOTYPES_BTTL_ITER_UPDATE_HPP
...
MEMORIA_ITERATOR_PART_BEGIN(memoria::bttl::IteratorUpdateName)
...
#define M_TYPE      MEMORIA_ITERATOR_TYPE(memoria::bttl::IteratorUpdateName)
