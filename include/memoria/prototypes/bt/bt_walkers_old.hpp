...
#ifndef _MEMORIA_PROTOTYPES_BALANCEDTREE_WALKERS_OLD_HPP
#define _MEMORIA_PROTOTYPES_BALANCEDTREE_WALKERS_OLD_HPP
...
public:
	FindWalkerBase0(Key key, Int key_num):
