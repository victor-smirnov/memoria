...
public:
    ...
    {
        typename Types::template FindGTWalker<Types, IntList<0>, IntList<0>> walker(stream, key_num, key_num - 1, key);
    ...
    {
        typename Types::template FindGEWalker<Types, IntList<0>, IntList<0>> walker(stream, key_num, key_num - 1, key);
