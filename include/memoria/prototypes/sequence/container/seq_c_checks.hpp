...
#ifndef _MEMORIA_PROTOTYPES_SEQUENCE_CONTAINER_SEQ_C_CHECKS_HPP
#define _MEMORIA_PROTOTYPES_SEQUENCE_CONTAINER_SEQ_C_CHECKS_HPP
...
MEMORIA_CONTAINER_PART_BEGIN(memoria::sequence::CtrChecksName)
private:
...
#define M_TYPE      MEMORIA_CONTAINER_TYPE(memoria::sequence::CtrChecksName)
