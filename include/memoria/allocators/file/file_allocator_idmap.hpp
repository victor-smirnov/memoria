...
#ifndef _MEMORIA_ALLOCATORS_FILE_ALLOCATOR_IDMAP_HPP
#define _MEMORIA_ALLOCATORS_FILE_ALLOCATOR_IDMAP_HPP
...
class IDMapFileAllocator: public IAllocator<PageType> {
...
private:
    typedef IDMapFileAllocator<BaseAllocator, PageType>                      MyType;

    BaseAllocator& allocator_;

public:
    IDMapFileAllocator(BaseAllocator& base_allocator): allocator_(base_allocator) {}

    virtual ~IDMapFileAllocator()
    {}
