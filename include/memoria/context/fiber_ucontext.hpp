...
#include <memoria/context/detail/exchange.hpp>
#endif
#include <memoria/context/detail/externc.hpp>
#if defined(BOOST_NO_CXX17_STD_INVOKE)
#include <memoria/context/detail/invoke.hpp>
#endif
#include <memoria/context/fixedsize_stack.hpp>
#include <memoria/context/flags.hpp>
#include <memoria/context/preallocated.hpp>
...
#if defined(BOOST_NO_CXX17_STD_INVOKE)
            c = memoria::context::detail::invoke( fn_, std::move( c) );
#else
