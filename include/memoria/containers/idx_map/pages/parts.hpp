...
#ifndef _MEMORIA_MODELS_VECTOR_PAGES_PARTS_HPP
#define	_MEMORIA_MODELS_VECTOR_PAGES_PARTS_HPP
...
using memoria::models::idx_map::IndexPagePrefixName;

#pragma pack(1)


MEMORIA_PAGE_PART_BEGIN2(IndexPagePrefixName<Indexes>, Int Indexes)
