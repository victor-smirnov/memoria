...
template<typename Types> class CollectionChunkImpl;

namespace bt {

template <typename Types, typename LeafPath, typename StateTypes>
class FindForwardShuttle<Types, LeafPath, CollectionChunkImpl<StateTypes>, DTOrdering::SUM>: public FindSumForwardShuttleBase<Types, LeafPath> {
    using Base = FindSumForwardShuttleBase<Types, LeafPath>;
    using StateT = CollectionChunkImpl<StateTypes>;
...
template <typename Types, typename LeafPath, typename StateTypes>
class FindForwardShuttle<Types, LeafPath, CollectionChunkImpl<StateTypes>, DTOrdering::MAX>: public FindMaxForwardShuttleBase<Types, LeafPath> {
...
template <typename Types, typename LeafPath, typename StateTypes>
class FindBackwardShuttle<Types, LeafPath, CollectionChunkImpl<StateTypes>, DTOrdering::SUM>: public FindSumBackwardShuttleBase<Types, LeafPath> {
...
class SkipForwardShuttle<Types, Stream, CollectionChunkImpl<StateTypes>>: public SkipForwardShuttleBase<Types, Stream> {
...
template <typename Types, size_t Stream, typename StateTypes>
class SkipBackwardShuttle<Types, Stream, CollectionChunkImpl<StateTypes>>: public SkipBackwardShuttleBase<Types, Stream> {
...
template <typename Types, typename LeafPath, typename StateTypes>
class SelectForwardShuttle<Types, LeafPath, CollectionChunkImpl<StateTypes>>: public SelectForwardShuttleBase<Types, LeafPath> {
...
template <typename Types, typename LeafPath, typename StateTypes>
class SelectBackwardShuttle<Types, LeafPath, CollectionChunkImpl<StateTypes>>: public SelectBackwardShuttleBase<Types, LeafPath> {
