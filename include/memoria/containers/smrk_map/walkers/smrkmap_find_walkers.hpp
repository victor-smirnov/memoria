...
#ifndef _MEMORIA_CONTAINERS_SMRKMAP_FIND_WALKERS_HPP
#define _MEMORIA_CONTAINERS_SMRKMAP_FIND_WALKERS_HPP
...
public:
    ...
    FindGTWalker(Int stream, Int key_num, Int key): Base(stream, key_num, key)
    {}
