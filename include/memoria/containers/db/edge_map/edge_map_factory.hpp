...
#include <memoria/containers/db/edge_map/edge_map_input.hpp>

#include <memoria/containers/db/edge_map/container/edge_map_c_api.hpp>
#include <memoria/containers/db/edge_map/iterator/edge_map_i_misc.hpp>

#include <memoria/containers/db/edge_map/edge_map_tools.hpp>
#include <memoria/containers/db/edge_map/edge_map_iterator.hpp>
