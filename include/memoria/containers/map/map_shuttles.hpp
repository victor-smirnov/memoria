...
class FindForwardShuttle<Types, LeafPath, MapChunkImpl<StateTypes>, DTOrdering::SUM>: public FindSumForwardShuttleBase<Types, LeafPath> {
    using Base = FindSumForwardShuttleBase<Types, LeafPath>;
    using StateT = MapChunkImpl<StateTypes>;
...
template <typename Types, typename LeafPath, typename StateTypes>
class FindForwardShuttle<Types, LeafPath, MapChunkImpl<StateTypes>, DTOrdering::MAX>: public FindMaxForwardShuttleBase<Types, LeafPath> {
...
template <typename Types, typename LeafPath, typename StateTypes>
class FindBackwardShuttle<Types, LeafPath, MapChunkImpl<StateTypes>, DTOrdering::SUM>: public FindSumBackwardShuttleBase<Types, LeafPath> {
...
class SkipForwardShuttle<Types, Stream, MapChunkImpl<StateTypes>>: public SkipForwardShuttleBase<Types, Stream> {
...
template <typename Types, size_t Stream, typename StateTypes>
class SkipBackwardShuttle<Types, Stream, MapChunkImpl<StateTypes>>: public SkipBackwardShuttleBase<Types, Stream> {
