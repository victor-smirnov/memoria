...
#ifndef _MEMORIA_CONTAINER_VECTORMAP2_C_CHECKS_HPP
...
MEMORIA_CONTAINER_PART_BEGIN(memoria::vmap::CtrChecksName)
...
#define M_TYPE      MEMORIA_CONTAINER_TYPE(memoria::vmap::CtrChecksName)
