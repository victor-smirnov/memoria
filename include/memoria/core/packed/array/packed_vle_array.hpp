...
#ifndef MEMORIA_CORE_PACKED_VLE_ARRAY_HPP_
...
class VLEArrayValueDescr {
    Value value_;
    Int pos_;
    Int idx_;
    Value prefix_;
public:
    VLEArrayValueDescr(BigInt value, Int pos, Int idx, Value prefix = 0):
        value_(value),
        pos_(pos),
        idx_(idx),
        prefix_(prefix)
...
public:
    ...
    typedef VLEArrayValueDescr<IndexValue>                                      ValueDescr;
    ...
    public:
        ...
        template<typename> friend class PackedVLEArray;
    };
...
public:
    ...
    static Int estimate_block_size(Int array_capacity, Int density_hi = 1000, Int density_lo = 333)
    {
        Int max_tree_capacity = (array_capacity * Blocks * density_hi) / density_lo;
...
private:
    ...
    public:
        ...
        void buildFirstIndexLine(Int index_level_start, Int index_level_size)
        {
            ...
            for (; idx < index_level_size && data_pos < limit; idx++, block_start += ValuesPerBranch)
            {
                ...
                {
                    Int len = codec.length(values_, data_pos, limit);
    ...
    public:
        ...
        void checkData()
        {
            ...
            {
                data_size_ += codec.length(values_, data_size_, limit);
                size_ ++;
            }
        }
    };
...
public:
    ...
    void insertSpace(Int, Int) {
        throw Exception(MA_SRC, "Method insertSpace(Int, Int) is not implemented for PackedVLEArray");
    }
    ...
    {
        throw Exception(MA_SRC, "copyTo() have not been fully implemented for this data structure yet");
    }
