...
#if BOOST_CLANG
#   include <memoria/core/integer/clang/integer_primitives.hpp>
#elif BOOST_MSVC
#   include <memoria/core/integer/msvc/integer_primitives.hpp>
#else
#   include <memoria/core/integer/gcc/integer_primitives.hpp>
#endif
