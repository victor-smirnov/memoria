...
class FLCtrBatchInput: public CtrBatchInputBase<MergeLists<Streams, TL<TL<IOSSRLEBuffer<ListSize<Streams>>>>>> {
    using Base = CtrBatchInputBase<MergeLists<Streams, TL<TL<IOSSRLEBuffer<ListSize<Streams>>>>>>;
