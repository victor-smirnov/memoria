...
#ifndef MEMORIA_FIBERS_PACKAGED_TASK_HPP
#define MEMORIA_FIBERS_PACKAGED_TASK_HPP
...
#include <memoria/fiber/future/detail/task_object.hpp>
#include <memoria/fiber/future/future.hpp>
...
public:
    ...
    explicit packaged_task( std::allocator_arg_t, Allocator const& alloc, Fn && fn) {
        ...
        >                                       traits_type;
        typedef ::boost::pointer_traits< typename traits_type::pointer > ptrait_type;
...
#endif // MEMORIA_FIBERS_PACKAGED_TASK_HPP
