...
class protected_stack_pool {
    ...
    class storage {
        struct ListNode: boost::intrusive::list_base_hook<> {
            memoria::context::stack_context stack_ctx_;
        };
    ...
    public:
        ...
        memoria::context::stack_context allocate()
        {
    ...
    private:
        ...
        memoria::context::stack_context create_new_node()
        {
...
public:
    protected_stack_pool(size_t min_pool_size, size_t stack_size = memoria::context::stack_traits::default_size()): 
