...
#ifndef MEMORIA_FIBERS_ALGO_SHARED_WORK_H
#define MEMORIA_FIBERS_ALGO_SHARED_WORK_H
...
class MEMORIA_FIBERS_DECL shared_work : public algorithm {
private:
...
#endif // MEMORIA_FIBERS_ALGO_SHARED_WORK_H
