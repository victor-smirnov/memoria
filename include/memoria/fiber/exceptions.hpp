...
template<>
struct is_error_code_enum< memoria::fibers::future_errc > : public true_type {
};

inline
std::error_code make_error_code( memoria::fibers::future_errc e) noexcept {
    return std::error_code{ static_cast< int >( e), memoria::fibers::future_category() };
}

inline
std::error_condition make_error_condition( memoria::fibers::future_errc e) noexcept {
    return std::error_condition{ static_cast< int >( e), memoria::fibers::future_category() };
}
