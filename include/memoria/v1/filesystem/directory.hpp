...
#ifndef MEMORIA_BOOST_FILESYSTEM3_DIRECTORY_HPP
#define MEMORIA_BOOST_FILESYSTEM3_DIRECTORY_HPP
...
{
public:
  typedef memoria::v1::filesystem::path::value_type value_type;   // enables class path ctor taking directory_entry

  directory_entry() BOOST_NOEXCEPT {}
  explicit directory_entry(const memoria::v1::filesystem::path& p) :
    m_path(p), m_status(file_status()), m_symlink_status(file_status())
  {
  }
  directory_entry(const memoria::v1::filesystem::path& p,
  ...
  void assign(const memoria::v1::filesystem::path& p,
  ...
  void replace_filename(const memoria::v1::filesystem::path& p,
    file_status st = file_status(), file_status symlink_st = file_status())
  {
...
# ifndef MEMORIA_BOOST_FILESYSTEM_NO_DEPRECATED
  void replace_leaf(const memoria::v1::filesystem::path& p, file_status st, file_status symlink_st)
  {
    replace_filename(p, st, symlink_st);
  }
# endif

  const memoria::v1::filesystem::path& path() const BOOST_NOEXCEPT { return m_path; }
  operator const memoria::v1::filesystem::path&() const BOOST_NOEXCEPT { return m_path; }
  file_status status() const { return get_status(); }
  file_status status(boost::system::error_code& ec) const BOOST_NOEXCEPT { return get_status(&ec); }
  file_status symlink_status() const { return get_symlink_status(); }
  file_status symlink_status(boost::system::error_code& ec) const BOOST_NOEXCEPT { return get_symlink_status(&ec); }
...
private:
  MEMORIA_BOOST_FILESYSTEM_DECL file_status get_status(boost::system::error_code* ec=0) const;
  MEMORIA_BOOST_FILESYSTEM_DECL file_status get_symlink_status(boost::system::error_code* ec=0) const;

private:
  memoria::v1::filesystem::path   m_path;
...
//  - a conversion to 'path' using 'operator const memoria::v1::filesystem::path&()',
...
MEMORIA_BOOST_FILESYSTEM_DECL void directory_iterator_construct(directory_iterator& it, const path& p, unsigned int opts, boost::system::error_code* ec);
MEMORIA_BOOST_FILESYSTEM_DECL void directory_iterator_increment(directory_iterator& it, boost::system::error_code* ec);
  ...
  >
{
  ...
  friend MEMORIA_BOOST_FILESYSTEM_DECL void detail::directory_iterator_construct(directory_iterator& it, const path& p, unsigned int opts, boost::system::error_code* ec);
  friend MEMORIA_BOOST_FILESYSTEM_DECL void detail::directory_iterator_increment(directory_iterator& it, boost::system::error_code* ec);
...
public:
  ...
  directory_iterator(const path& p, boost::system::error_code& ec) BOOST_NOEXCEPT
  {
    detail::directory_iterator_construct(*this, p, static_cast< unsigned int >(directory_options::none), &ec);
  }

  directory_iterator(const path& p, BOOST_SCOPED_ENUM_NATIVE(directory_options) opts, boost::system::error_code& ec) BOOST_NOEXCEPT
  {
  ...
  directory_iterator& increment(boost::system::error_code& ec) BOOST_NOEXCEPT
  {
...
//  namespace memoria::v1 template specializations
template<typename C, typename Enabler>
struct range_mutable_iterator;

template<>
struct range_mutable_iterator<memoria::v1::filesystem::directory_iterator, void>
{
  typedef memoria::v1::filesystem::directory_iterator type;
};
...
template<>
struct range_const_iterator<memoria::v1::filesystem::directory_iterator, void>
{
  typedef memoria::v1::filesystem::directory_iterator type;
};
...
#endif // MEMORIA_BOOST_FILESYSTEM_NO_DEPRECATED
...
MEMORIA_BOOST_FILESYSTEM_DECL void recursive_directory_iterator_construct(recursive_directory_iterator& it, const path& dir_path, unsigned int opts, boost::system::error_code* ec);
MEMORIA_BOOST_FILESYSTEM_DECL void recursive_directory_iterator_increment(recursive_directory_iterator& it, boost::system::error_code* ec);
MEMORIA_BOOST_FILESYSTEM_DECL void recursive_directory_iterator_pop(recursive_directory_iterator& it, boost::system::error_code* ec);
  ...
  >
{
  ...
  friend MEMORIA_BOOST_FILESYSTEM_DECL void detail::recursive_directory_iterator_construct(recursive_directory_iterator& it, const path& dir_path, unsigned int opts, boost::system::error_code* ec);
  friend MEMORIA_BOOST_FILESYSTEM_DECL void detail::recursive_directory_iterator_increment(recursive_directory_iterator& it, boost::system::error_code* ec);
  friend MEMORIA_BOOST_FILESYSTEM_DECL void detail::recursive_directory_iterator_pop(recursive_directory_iterator& it, boost::system::error_code* ec);
...
public:
  ...
  recursive_directory_iterator(const path& dir_path, boost::system::error_code& ec)
  {
  ...
  recursive_directory_iterator(const path& dir_path, BOOST_SCOPED_ENUM_NATIVE(directory_options) opts, boost::system::error_code& ec)
  {
  ...
  recursive_directory_iterator(const path& dir_path, BOOST_SCOPED_ENUM_NATIVE(symlink_option) opts, boost::system::error_code& ec) BOOST_NOEXCEPT
  {
    detail::recursive_directory_iterator_construct(*this, dir_path, static_cast< unsigned int >(opts), &ec);
  }
#endif // MEMORIA_BOOST_FILESYSTEM_NO_DEPRECATED
  ...
  recursive_directory_iterator& increment(boost::system::error_code& ec) BOOST_NOEXCEPT
  {
  ...
  void pop(boost::system::error_code& ec) BOOST_NOEXCEPT
  {
...
//  namespace memoria::v1 template specializations
template<>
struct range_mutable_iterator<memoria::v1::filesystem::recursive_directory_iterator, void>
{
  typedef memoria::v1::filesystem::recursive_directory_iterator type;
};
template<>
struct range_const_iterator<memoria::v1::filesystem::recursive_directory_iterator, void>
{
  typedef memoria::v1::filesystem::recursive_directory_iterator type;
};
...
#endif // MEMORIA_BOOST_FILESYSTEM3_DIRECTORY_HPP
