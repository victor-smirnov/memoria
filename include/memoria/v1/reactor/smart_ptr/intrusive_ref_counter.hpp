...
{
    typedef reactor::detail::atomic_count type;

    static unsigned int load(reactor::detail::atomic_count const& counter) noexcept
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(reactor::detail::atomic_count& counter) noexcept
    {
        ++counter;
    }

    static unsigned int decrement(reactor::detail::atomic_count& counter) noexcept
    {
