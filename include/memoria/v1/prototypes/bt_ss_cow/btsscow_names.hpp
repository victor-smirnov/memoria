...
struct SSCowCtrTypesT: BTCowCtrTypesT<Types>         {};

template <typename Types>
struct SSCowIterTypesT: BTCowIterTypesT<Types>   {};


template <typename Types>
using BTCowSSCtrTypes = BTCowCtrTypesT<SSCowCtrTypesT<Types>>;

template <typename Types>
using BTCowSSIterTypes = BTCowIterTypesT<SSCowIterTypesT<Types>>;
