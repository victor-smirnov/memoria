...
using BTFLSizePath = typename SublistFromStart<FullPath, ListSize<FullPath>::Value - 1>::Type;

template <typename FullPath>
using BTFLSizePathBlockIdx = ListHead<typename SublistToEnd<FullPath, ListSize<FullPath>::Value - 1>::Type>;
