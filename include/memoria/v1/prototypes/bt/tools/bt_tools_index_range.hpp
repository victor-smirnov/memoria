...
namespace {
    ...
    template <typename T, Int From, Int To, typename... Tail, Int Idx, template <typename, Int, Int> class IndexVector>
    ...
    template <typename T, Int From, Int To, Int Idx, template <typename, Int, Int> class IndexVector>
