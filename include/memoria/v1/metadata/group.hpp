...
public:
    ...
    MetadataGroup(U16StringRef name, const MetadataList &content, int32_t block_size = 0, int32_t type = Metadata::GROUP):
    ...
    MetadataGroup(U16StringRef name, int32_t block_size = 0, int32_t type = Metadata::GROUP):
