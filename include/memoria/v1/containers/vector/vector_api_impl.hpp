...
template <typename Value, typename Profile>
std::shared_ptr<io::IOVector> ICtrApi<Vector<Value>, Profile>::create_iovector()
{
    return SharedCtr<Vector<Value>, ProfileAllocatorType<Profile>, Profile>::create_iovector();
}
