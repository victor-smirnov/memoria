...
#ifndef MEMORIA_FIBERS_CUDA_WAITFOR_H
#define MEMORIA_FIBERS_CUDA_WAITFOR_H
...
#include <memoria/v1/fiber/detail/is_all_same.hpp>
...
std::vector< std::tuple< cudaStream_t, cudaError_t > > waitfor_all( cudaStream_t st0, STP ... stx) {
    static_assert( memoria::v1::fibers::detail::is_all_same< cudaStream_t, STP ...>::value, "all arguments must be of type `CUstream*`.");
