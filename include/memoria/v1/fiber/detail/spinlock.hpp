...
# include <mutex>
# include <memoria/v1/fiber/detail/spinlock_ttas_adaptive.hpp>
# include <memoria/v1/fiber/detail/spinlock_ttas.hpp>
# if defined(MEMORIA_FIBERS_HAS_FUTEX)
#  include <memoria/v1/fiber/detail/spinlock_ttas_adaptive_futex.hpp>
#  include <memoria/v1/fiber/detail/spinlock_ttas_futex.hpp>
# endif
# if defined(BOOST_USE_TSX)
#  include <memoria/v1/fiber/detail/spinlock_rtm.hpp>
# endif
#endif
