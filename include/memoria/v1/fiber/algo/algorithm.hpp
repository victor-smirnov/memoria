...
#ifndef MEMORIA_FIBERS_ALGO_ALGORITHM_H
#define MEMORIA_FIBERS_ALGO_ALGORITHM_H
...
class MEMORIA_FIBERS_DECL algorithm {
private:
    std::atomic< std::size_t >    use_count_{ 0 };

public:
    typedef ::boost::intrusive_ptr< algorithm >  ptr_t;
...
class MEMORIA_FIBERS_DECL algorithm_with_properties_base : public algorithm {
public:
