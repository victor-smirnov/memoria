...
#ifndef MEMORIA_CONTEXT_FIBER_H
#define MEMORIA_CONTEXT_FIBER_H
...
#include <memoria/v1/context/detail/disable_overload.hpp>
#if defined(BOOST_NO_CXX14_STD_EXCHANGE)
#include <memoria/v1/context/detail/exchange.hpp>
#endif
#include <memoria/v1/context/detail/externc.hpp>
#if defined(BOOST_NO_CXX17_STD_INVOKE)
#include <memoria/v1/context/detail/invoke.hpp>
#endif
#include <memoria/v1/context/fixedsize_stack.hpp>
#include <memoria/v1/context/flags.hpp>
#include <memoria/v1/context/preallocated.hpp>
...
struct MEMORIA_CONTEXT_DECL fiber_activation_record {
    ucontext_t                                                  uctx{};
    stack_context                                               sctx{};
    bool                                                        main_ctx{ true };
    ...
    virtual ~fiber_activation_record() noexcept {}
...
struct MEMORIA_CONTEXT_DECL fiber_activation_record_initializer {
...
#if defined(BOOST_NO_CXX17_STD_INVOKE)
            c = memoria::v1::context::detail::invoke( fn_, std::move( c) );
#else
...
class MEMORIA_CONTEXT_DECL fiber {
private:
