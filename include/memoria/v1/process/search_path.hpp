...
/**
 * \file memoria/v1/process/search_path.hpp
 *
...
#include <memoria/v1/process/detail/posix/search_path.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <memoria/v1/process/detail/windows/search_path.hpp>
#endif
