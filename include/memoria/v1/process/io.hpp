...
#include <memoria/v1/process/detail/posix/asio_fwd.hpp>
#include <memoria/v1/process/detail/posix/close_in.hpp>
#include <memoria/v1/process/detail/posix/close_out.hpp>
#include <memoria/v1/process/detail/posix/null_in.hpp>
#include <memoria/v1/process/detail/posix/null_out.hpp>
#include <memoria/v1/process/detail/posix/file_in.hpp>
#include <memoria/v1/process/detail/posix/file_out.hpp>
#include <memoria/v1/process/detail/posix/pipe_in.hpp>
#include <memoria/v1/process/detail/posix/pipe_out.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <memoria/v1/process/detail/windows/asio_fwd.hpp>
#include <memoria/v1/process/detail/windows/close_in.hpp>
#include <memoria/v1/process/detail/windows/close_out.hpp>
#include <memoria/v1/process/detail/windows/null_in.hpp>
#include <memoria/v1/process/detail/windows/null_out.hpp>
#include <memoria/v1/process/detail/windows/file_in.hpp>
#include <memoria/v1/process/detail/windows/file_out.hpp>
#include <memoria/v1/process/detail/windows/pipe_in.hpp>
#include <memoria/v1/process/detail/windows/pipe_out.hpp>
#endif

/** \file memoria/v1/process/io.hpp
 *
...
\note `memoria/v1/process/async.hpp` must also be included for this to work.
...
\warning This feature requires `memoria/v1/process/async.hpp` to be included and a reference to `boost::asio::io_context` to be passed to the launching function.
