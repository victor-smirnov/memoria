...
/** \file memoria/v1/process/async.hpp
...
#include <memoria/v1/process/detail/traits.hpp>
#include <memoria/v1/process/detail/on_exit.hpp>
...
#include <memoria/v1/process/detail/posix/io_context_ref.hpp>
#include <memoria/v1/process/detail/posix/async_in.hpp>
#include <memoria/v1/process/detail/posix/async_out.hpp>
#include <memoria/v1/process/detail/posix/on_exit.hpp>

#elif defined(BOOST_WINDOWS_API)
#include <memoria/v1/process/detail/windows/io_context_ref.hpp>
#include <memoria/v1/process/detail/windows/async_in.hpp>
#include <memoria/v1/process/detail/windows/async_out.hpp>
#include <memoria/v1/process/detail/windows/on_exit.hpp>
#endif
