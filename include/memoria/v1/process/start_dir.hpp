...
#include <memoria/v1/process/locale.hpp>

#if defined (BOOST_POSIX_API)
#include <memoria/v1/process/detail/posix/start_dir.hpp>
#elif defined (BOOST_WINDOWS_API)
#include <memoria/v1/process/detail/windows/start_dir.hpp>
#endif
...
/** \file memoria/v1/process/start_dir.hpp
 *
