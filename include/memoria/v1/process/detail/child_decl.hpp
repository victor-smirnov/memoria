...
/**
 * \file memoria/v1/process/child.hpp
 *
...
#include <memoria/v1/process/detail/posix/child_handle.hpp>
#include <memoria/v1/process/detail/posix/terminate.hpp>
#include <memoria/v1/process/detail/posix/wait_for_exit.hpp>
#include <memoria/v1/process/detail/posix/is_running.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <memoria/v1/process/detail/windows/child_handle.hpp>
#include <memoria/v1/process/detail/windows/terminate.hpp>
#include <memoria/v1/process/detail/windows/wait_for_exit.hpp>
#include <memoria/v1/process/detail/windows/is_running.hpp>
