...
#include <memoria/v1/process/detail/traits/cmd_or_exe.hpp>
#include <memoria/v1/process/detail/traits/wchar_t.hpp>

#if defined( BOOST_WINDOWS_API )
#include <memoria/v1/process/detail/windows/basic_cmd.hpp>
#include <memoria/v1/process/detail/windows/cmd.hpp>
#elif defined( BOOST_POSIX_API )
#include <memoria/v1/process/detail/posix/basic_cmd.hpp>
#include <memoria/v1/process/detail/posix/cmd.hpp>
#endif

#include <memoria/v1/process/shell.hpp>
